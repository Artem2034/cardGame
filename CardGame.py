...
from CardGame.game_cards import Player
...
class Game:
    ...
    def _launching(self):
        ...
        self.player = CardGame.game_cards.Player()
    ...
    def remove_player(self, player):
        player.print_cards()
        if isinstance(player, CardGame.game_cards.Player):
            print('You are fall!')
    ...
    def ask_cards(self):
        for player in self.players:
            ...
            while player.ask_card():
                ...
                if is_stop:
                    if player.full_points > 21 or isinstance(player, CardGame.game_cards.Player):
        ...
        if self.dealer.full_points > 21:
            ...
            for player in self.players:
                if player.full_points == self.dealer.full_points:
                    ...
                    elif isinstance(player, CardGame.game_cards.Player):
                        print('You are win!')
